...
class PaymentServiceTest {
    ...
    void testGetUserPayments_success() {
        ...
        when(paymentRepository.findByUserUserIdOrderByCreatedAtDesc(1L))
    ...
    void testGetUserPayments_userNotFound() {
        ...
        assertThrows(ResourceNotFoundException.class,
                () -> paymentService.getUserPayments(1L));
    }
    ...
    void testGetUserPayments_multiplePayments() {
        ...
        assertEquals(12L, result.get(0).getPaymentId());
        assertEquals(13L, result.get(1).getPaymentId());
    }
}